 const styles = {
  ...
  heading2:
    "font-Sans-pro font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full",
  paragraph:
  ...
  flexInlineStart: "inline-flex justify-center items-start",
